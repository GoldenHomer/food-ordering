...
router.post('/orderform', function(req, res) {
    ...
    access.find({ id: sessionID }).on('success', function (doc) {
        ...
        if (doc[0].admin === "yes") {
            ...
            var restaurantPrice = req.body.restaurantPrice;
            console.log("restaurantName = " + restaurantName);
            console.log("restaurantPrice = " + restaurantPrice);
            ...
            collection.insert(
                {order: {restname: restaurantName, date: currentdate, price: restaurantPrice}},
                function (err, doc) {
                    if(err) {
                        res.send("There was a problem submitting your menu item.");
                    }
